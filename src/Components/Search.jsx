...
export default function Search(){
    ...
    return(
        ...
        <div style={{
            ...
            <h3 style={{ margin: 0, marginRight: '10px', fontSize: '16px' }}>Categories</h3>
        ...
        <div style={{
            ...
            <button className="color" onClick={()=>setSortOrder("low")} style={btnStyle}>
                Price: Low to High
            </button>
            <button className="color" onClick={()=>setSortOrder("high")} style={btnStyle}>
                Price: High to Low
            </button>
            <button onClick={handleWishlist} className='hover' style={btnStyle}>
                WishLists
            </button>
        </div>
            ...
            {filteredProducts.length === 0 ? (
                ...
                >
                    ...
                    <button
                        style={{
                            height: '32px',
                            background: wishList.some((item) => item.id === product.id) ? '#ff4d4d' : '#443e3e',
                            color: 'white',
                            border: 'none',
                            cursor: 'pointer',
                            fontSize: '16px'
